        ...
        initializeSlick = function () {
          return $timeout(function () {
			...
			.on('init', function(evt, slick){
                 if (attrs.onInit) {
                   scope.onInit({evt:evt, slick:slick});
                 }
            ...
            .slick({
              waitForAnimate: scope.waitForAnimate === 'true',
			...
			verticalSwiping: scope.verticalSwiping != null ? parseInt(scope.verticalSwiping, 10) : 1,
